...
export default function App() {
  ...
  if (!session) return (
    <div style={{ background: COLORS.bg, minHeight: "100vh", fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      <link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=DM+Sans:wght@400;500;600;700&display=swap" rel="stylesheet" />
      <div style={{ maxWidth: 480, margin: "0 auto", padding: "64px 24px", textAlign: "center" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, marginBottom: 24 }}>
          <img src="/logo.png" alt="" width={40} height={40} style={{ borderRadius: "50%", flexShrink: 0 }} />
          <span style={{ fontSize: 22, fontWeight: 700, color: COLORS.textPrimary }}>My BMX Season</span>
        </div>
        <p style={{ color: COLORS.textSecondary, fontSize: 15, lineHeight: 1.6, marginBottom: 32 }}>
          My BMX Season helps UK BMX riders and parents keep track of the national race calendar,
          regional and club race series, and every entry or booking deadline — all in one place,
          with reminders before you miss a cut-off.
        </p>
        <div style={{ background: COLORS.card, border: `1px solid ${COLORS.border}`, borderRadius: 16, padding: 40 }}>
          <div style={{ fontSize: 13, color: COLORS.textMuted, marginBottom: 16 }}>Sign in to build your personal season</div>
          <button
        ...
        <div style={{ marginTop: 24 }}>
          <a href="/privacy.html" style={{ color: COLORS.textMuted, fontSize: 12 }}>Privacy Policy</a>
        </div>
      </div>
    </div>
  );
